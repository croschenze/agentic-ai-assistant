...
class ParticipantInterface {
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                aiGreeting: 'Hello! I am your Image AI assistant. I can help you with image generation, editing, and analysis. What can I help you with?',
            ...
            zh: {
                ...
                aiGreeting: '您好！我是您的Image AI助手。我可以帮助您进行图像生成、编辑和分析。请告诉我您需要什么帮助？',
    ...
    addMessage(sender, text, avatarName = null, avatarIcon = null) {
        ...
        if (sender === 'ai' || sender === 'wizard') {
            ...
            senderName.textContent = avatarName || 'Image AI';
    ...
    updateControlPanelLanguage() {
        ...
        if (creativitySlider) {
            const creativityLabel = creativitySlider.closest('.setting-group').querySelector('.setting-label');
            if (creativityLabel) {
                creativityLabel.textContent = this.t('creativity');
            }
        }
        
        const personalitySlider = document.querySelector('#personality-slider');
        if (personalitySlider) {
            const personalityLabel = personalitySlider.closest('.setting-group').querySelector('.setting-label');
            if (personalityLabel) {
                personalityLabel.textContent = this.t('personality');
            }
        }
        
        const workstyleSlider = document.querySelector('#workstyle-slider');
        if (workstyleSlider) {
            const workstyleLabel = workstyleSlider.closest('.setting-group').querySelector('.setting-label');
            if (workstyleLabel) {
        ...
        // 更新滑块左右标签 - 添加空检查
        const creativitySliderContainer = document.querySelector('#creativity-slider');
        if (creativitySliderContainer) {
            const creativityLabels = creativitySliderContainer.closest('.slider-container').querySelectorAll('.slider-labels span');
        ...
        const personalitySliderContainer = document.querySelector('#personality-slider');
        if (personalitySliderContainer) {
            const personalityLabels = personalitySliderContainer.closest('.slider-container').querySelectorAll('.slider-labels span');
        ...
        const workstyleSliderContainer = document.querySelector('#workstyle-slider');
        if (workstyleSliderContainer) {
            const workstyleLabels = workstyleSliderContainer.closest('.slider-container').querySelectorAll('.slider-labels span');
...
// 设置模式切换 - 已移除，因为只保留图像编辑设置
function setupModeToggle() {
    // 不需要模式切换功能，因为只有图像编辑设置
    return;
}
